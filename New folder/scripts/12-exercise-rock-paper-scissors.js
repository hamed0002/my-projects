...
function autoPlay(){
  ...
  intervalId = setInterval(() => {
      ...
      document.querySelector('.auto-play-button').style.backgroundColor ='red';
    },1000);
    isAutoPlaying = true
  }else{
    ...
    document.querySelector('.auto-play-button').style = null
  }
  }
  ...
  document.querySelector('.reset-score-button').addEventListener('click',()=>{showResetConfirmation()})
